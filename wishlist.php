                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
										...
										?>
											<tr>
												<td class="product-thumbnail"><a href="product.php?id=<?php echo $row['pid']; ?>"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row['image']?>"  /></a></td>
												<td class="product-name"><a href="#"><?php echo $row['name']?></a>
													<ul  class="pro__prize">
														<strike><li class="old__prize"><?php echo $row['mrp']?></li></strike>
														<li><?php echo $row['price']?></li>
													</ul>
												</td>
												
												<td class="product-remove"><a href="wishlist.php?wishlist_id=<?php echo $row['id']?>"><i class="icon-trash icons"></i></a></td>
												<td class="product-remove"><a  style="background-color: rgba(0,0,0,0.8); color: whitesmoke; text-transform: uppercase; font-size: 1rem; width: 150px; height: 50px; padding: 10px; border-radius: 3px;" href="javascript:void(0)" onclick="manage_cart('<?php echo $row['pid']?>','add')">Add to Cart</a></td>
											</tr>
											<?php } ?>
                                    </tbody>
                                </table>
