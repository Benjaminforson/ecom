...
(1, 'GhProfit', 'GhProfit@ghprofit.com', '1234567890', 'Test Query', '2020-01-14 00:00:00'),
(2, 'GhProfit@ghprofit.com', '', '1234567890', 'testing', '2020-01-19 07:59:38'),
(3, 'GhProfit', 'GhProfit@ghprofit.com', '1234567890', 'testing', '2020-01-19 08:00:09'),
(4, 'test', 'test@ghprofit.com', '9990413778', 'test', '2020-05-01 09:21:37');
...
(3, 1, 'Essikado', 'Essikado', 110076, 'COD', 10, 'pending', 2, 0, 0, 0, 0, '8834142e7821c1889b33', '', 0, 0, '', 0, '', '', '2020-05-20 07:44:24'),
(4, 1, 'Essikado', 'Essikado', 110076, 'COD', 12000, 'pending', 2, 0, 0, 0, 0, '1bf668ba03dc15833001', '', 0, 0, '', 0, '', '', '2020-05-20 07:56:44'),
(5, 1, 'Essikado', 'Essikado', 110076, 'payu', 16998, 'pending', 3, 0, 0, 0, 0, '8b1b93a4b63e0b2307a0', '', 0, 0, '', 0, '', '', '2020-05-20 08:10:37'),
...
(9, 1, 'Essikado', 'Essikado', 110076, 'COD', 1900, 'pending', 4, 0, 0, 0, 0, '62d6625c440ecc84aa78', '', 0, 0, '', 0, '', '', '2020-05-22 09:58:57'),
(10, 1, 'Kwadjo Krom', 'Essikado', 110076, 'COD', 150, 'pending', 3, 0, 0, 0, 0, '3532b3a4441fa64e2918', '', 0, 0, '', 0, '', '', '2020-05-23 10:45:15'),
(11, 1, 'Kwadjo Krom', 'Essikado', 110076, 'COD', 50, 'pending', 3, 20, 20, 20, 2.5, '1fbc5a06bfa6e2299f79', '', 0, 0, '', 0, '', '', '2020-05-25 06:49:19'),
(13, 1, 'Essikado', 'Essikado', 110076, 'COD', 1560, 'pending', 1, 0, 0, 0, 0, '68d2cc3d52d8f21197fb', '', 0, 0, '', 1, '1000', 'First50', '2020-05-26 08:06:32'),
(14, 1, 'Essikado', 'Essikado', 10076, 'COD', 560, 'pending', 1, 0, 0, 0, 0, '901aa3cb126d2448d5e9', '', 0, 0, '', 1, '1000', 'First50', '2020-05-26 08:07:48'),
(16, 1, 'Kwadjo Krom', 'Essikado', 110076, 'COD', 1560, 'pending', 4, 20, 20, 20, 2.5, 'af5421697c0e596ca7f9', '', 38845635, 38565829, '', 0, '', '', '2020-05-25 06:49:42');
...
-- --------------------------------------------------------
CREATE TABLE `elicart`.`transactions` ( `id` INT(11) NOT NULL AUTO_INCREMENT , `uid` INT(11) NOT NULL , `clientid` VARCHAR(255) NOT NULL , `email` VARCHAR(255) NOT NULL , `amount` VARCHAR(255) NOT NULL , `status` VARCHAR(255) NOT NULL , `reason` VARCHAR(255) NOT NULL , `reference` VARCHAR(255) NOT NULL , `telcodtransid` VARCHAR(255) NOT NULL , `phone` VARCHAR(255) NOT NULL , `network` VARCHAR(255) NOT NULL , `trans_date` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
...
(1, 'GhProfit', 'GhProfit', 'email@ghprofit.com', '1234567890', '2020-05-13 00:00:00'),
(2, 'Elorm', 'Elorm', 'daniel@ghprofit.com', '1234567890', '2020-05-14 00:00:00'),
(3, 'GhProfit', 'GhProfit', 'admin@ghprofit.com', '9540608104', '2020-05-16 01:24:15');
