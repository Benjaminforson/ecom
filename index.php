                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        ...
                                        <span class="badge badge-secondary">-30%</span>
                                            <img style="border-radius: 3px;" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images">
                                        </a>
                                    </div>
                                    ...
                                    <div class="fr__product__inner">
                                        ...
                                        <ul class="fr__pro__prize">
                                           <strike> <li class="old__prize">GH₵ <?php echo $list['mrp']?></li></strike>
                                            <li>GH₵ <?php echo $list['price']?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="ftr__product__area ptb--100">
            <div class="container">
                ...
                <div class="row">
                    <div class="product__list clearfix mt--30">
							<?php
							$get_product=get_product($con,16,'','','','','yes');
							foreach($get_product as $list){
							?>
                            <!-- Start Single Category -->
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
